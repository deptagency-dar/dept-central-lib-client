...
export const StatusBadge = ({ type, text = null }: StatusBadgeProps) => {
  return (
    <div className="flex flex-row items-center pl-2 py-2 pr-3 rounded-full h-6 w-fit text-nowrap ${className} ${styles[type]}">
      <div
